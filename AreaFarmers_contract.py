...
class Product:
    ...
    def application_creation(self):
        return Seq([
            ...
            Assert(Txn.note() == Bytes("AreaFarmers:uv1")),
            Assert(Btoi(Txn.application_args[3]) > Int(0)),
            App.globalPut(self.Variables.user, Txn.application_args[0]),
            App.globalPut(self.Variables.product, Txn.application_args[1]),
